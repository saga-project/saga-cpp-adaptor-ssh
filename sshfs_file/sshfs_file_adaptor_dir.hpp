...
#ifndef ADAPTORS_SSHFS_FILE_ADAPTOR_DIR_HPP
#define ADAPTORS_SSHFS_FILE_ADAPTOR_DIR_HPP
...
namespace sshfs_filesystem_adaptor 
{
  ...
  class dir_cpi_impl : public saga::adaptors::v1_0::directory_cpi<dir_cpi_impl>
  {
    private:
      ...
      /* adaptor data */
      typedef saga::adaptors::adaptor_data <filesystem_adaptor> adaptor_instance_data_t;

      // /* adaptor suite data */
      // typedef      saga::adaptors::adaptor_suite_data 
      //                                            <ssh::suite, filesystem_adaptor> 
      //                                             suite_data_t;
      ...
      saga::filesystem::directory d_;         // proxy directory
...
#endif // ADAPTORS_SSHFS_FILE_ADAPTOR_DIR_HPP
